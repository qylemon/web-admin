...
<script>
    ...
    export default {
      ...
      methods:{
        ...
        mounted:function(){
            var chartData = [["2018/08", 50], ["2018/09", 60], ["2018/10", 100], ["2018/11",200], ["2018/12",350], ["2019/01",600], ["2019/02",955]];
    ...
    function drawMarkers(){
        ...
        ctx.fillText("访问量/百", -canvas.height/2, cSpace-10);
        ctx.restore();
        // 绘制标题 x
